...
public class day2_part2{
    ...
    public static void main(String[] args) {
        ...
        int col = 16;
        int checksum = 0;
        String values = "3751	3769	2769	2039	2794	240	3579	1228	4291	220	324	3960	211	1346	237	1586 "+
        ...
        for(int i=0; i<row; i++){
            for(int j=0; j<col; j++){
                for(int k = j+1; k < col; k++){
                    if (sheet[i][j]%sheet[i][k] == 0 || sheet[i][k]%sheet[i][j] == 0){
                        checksum += getMax(sheet[i][j]/sheet[i][k], sheet[i][k]/sheet[i][j]);
                        k = col;
                    }
                }
            }
